...
eventsRouter.route('/').get((req,res,next)=>{
    ...
    const { event_recipe_id, host_id, event_date} = req.body
    const newEvent = { event_recipe_id, host_id,event_date }
...
.all((req,res,next)=>{
    ...
    const {event_date, host_id, event_recipe_id} = req.body
    const eventToUpdate = {event_date, host_id, event_recipe_id}
